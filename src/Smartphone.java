...
public class Smartphone {
	 ...
	 */
    public String locateRoadRunner(String city, String state) throws IOException {
			
		System.out.println("localización: " + city + ", " + state);
    ...
    /**
     * <p>
     * No exceda más de 30 voltios o la función de zap será con traproducente.
     * </p>
     *
     * @param voltage indica el número de voltios que se enviarán al cuerpo del
     * correcaminos
